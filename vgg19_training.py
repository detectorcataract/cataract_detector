...
MODEL_DIR = Path('/content/drive/MyDrive/vgg19_model')
MODEL_DIR.mkdir(parents=True, exist_ok=True)
MODEL_PATH = MODEL_DIR / 'cataract_vgg19.keras'
...
model = keras.Model(inputs, outputs, name='cataract_vgg19')
model.compile(
...
(MODEL_DIR / 'vgg19_training_history.json').write_text(json.dumps(history_df, indent=2))
